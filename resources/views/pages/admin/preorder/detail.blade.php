    ...
    <div class="container  px-6 pb-6 mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div class="col-span-2 flex flex-col gap-8">
                <div class="bg-white rounded-3xl p-8">
                    <p class="text-sm md:text-base text-gray-800 font-medium mb-2">Informasi Pembeli</p>
                    <hr>
                    <div class="flex flex-col gap-2 mt-1">
                        <div class="grid grid-cols-6 justify-start items-start">
                            <p class="text-sm md:text-base col-span-2 text-gray-500">Nama</p>
                            <p class="text-sm md:text-base col-span-4 text-gray-800 font-medium">{{ $data->pembelis->nama }}
                            </p>
                        </div>
                        <div class="grid grid-cols-6 justify-start items-start">
                            <p class="text-sm md:text-base col-span-2 text-gray-500">Email</p>
                            <p class="text-sm md:text-base col-span-4 text-gray-800 font-medium">
                                {{ $data->pembelis->email }}</p>
                        </div>
                        <div class="grid grid-cols-6 justify-start items-start">
                            <p class="text-sm md:text-base col-span-2 text-gray-500">Alamat</p>
                            <p class="text-sm md:text-base col-span-4 text-gray-800 font-medium">
                                {{ $data->pembelis->alamat }}</p>
                        </div>
                        <div class="grid grid-cols-6 justify-start items-start">
                            <p class="text-sm md:text-base col-span-2 text-gray-500">No Hp</p>
                            <p class="text-sm md:text-base col-span-4 text-gray-800 font-medium">
                                {{ $data->pembelis->no_hp }}</p>
                        </div>
                    </div>
                </div>
                @if ($data->is_Preorder == true && $data->Preorder_id != null)
                    <div class="bg-white rounded-3xl p-8">
                        <p class="text-sm md:text-base text-gray-800 font-medium mb-2">Informasi Preorder</p>
                        <hr>
                        <div class="grid grid-cols-2 justify-start items-start">
                            ...
                            <p class="text-sm md:text-base col-span-1 text-gray-800 font-medium">
                        ...
                        <div class="flex flex-col gap-2 mt-1">
                            <div class="grid grid-cols-2 justify-start items-start">
                                ...
                                <p class="text-sm md:text-base col-span-1 text-gray-800 font-medium">Rp.
                            ...
                            @if ($data->is_complete == 1)
                                <div class="grid grid-cols-2 justify-start items-start">
                                    ...
                                    <p class="text-sm md:text-base col-span-1 text-green-500    font-medium">Lunas</p>
                                </div>
                            @elseif ($data->is_complete == 0)
                                <div class="grid grid-cols-2 justify-start items-start">
                                    <p class="text-sm col-span-1 text-gray-500 whitespace-nowrap">Kekurangan Harga</p>
                                    <p class="text-sm md:text-base col-span-1 text-red-400 font-medium">Rp.
