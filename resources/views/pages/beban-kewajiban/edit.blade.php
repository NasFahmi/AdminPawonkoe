        ...
        <div class="bg-white px-8 py-8 shadow-lg rounded-3xl">
            <form action="{{ route('beban-kewajibans.update', $data->id) }}" method="post">
                        ...
                        <div class="max-w-lg">
                            <div class="flex flex-col gap-3">
                                <div class="w-full">
                                    ...
                                    <select name="jenis" class="bg-gray-50 border max-w-4xl border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                        <option value="" disabled selected>Pilih Jenis</option>
                                        <option value="beban" {{ old('jenis', $data->jenis) == 'beban' ? 'selected' : '' }}>Beban</option>
                                        <option value="kewajiban" {{ old('jenis', $data->jenis) == 'kewajiban' ? 'selected' : '' }}>Kewajiban</option>
                                    </select>
                                    @error('jenis')
                                ...
                                <div class="w-full mt-4">
                                    ...
                                    <input type="text" name="nama" value="{{ old('nama', $data->nama) }}" placeholder="Nama"
                    ...
                    <div class="right">
                        ...
                        <div class="w-full mt-5">
                            ...
                            <div class="relative max-w-lg mt-2">
                                ...
                                <input datepicker type="text" name="tanggal"value="{{ old('tanggal', \Carbon\Carbon::parse($data->tanggal)->format('m/d/Y')) }}" 
                ...
                <div class="flex justify-center items-center mt-8">
                    <button type="submit"
                            class="bg-green-400 text-white px-4 py-2 w-full lg:w-fit rounded-lg hover:bg-green-500 transition duration-300">Submit</button>
                </div>
            </form>
        </div>
    </div>
