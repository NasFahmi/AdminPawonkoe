...
@section('title', 'Admin Beban Kewajiban')
@section('content')
<div class="container px-6 pb-6 mx-auto ">
    <p class="text-2xl my-6 font-semibold text-gray-700">Beban & Kewajiban</p>
    {{-- <p>{{$data}}</p> --}}
    <div
        ...
        <div class="flex justify-start items-start md:items-center flex-col gap-4 w-full lg:flex-row ">
            ...
            <div class="flex justify-center items-center flex-col md:flex-row gap-4 w-full md:w-fit ">
                <a href="{{ route('beban-kewajibans.create') }}"
                    ...
                    <span class="font-semibold text-sky-600 text-sm">Tambah Kewajiban</span>
                </a>
            </div>
        </div>
    </div>
                ...
                {{-- <tbody>
                    ...
                    <tr
                        ...
                        <td cope="row" class="w-10 h-16   px-4 py-2 lg:whitespace-nowrap">
                            <span>Rp. {{ number_format($history_product->history_product->harga, 0, ',', '.') }}</span>
                        </td>
                        @endforeach
