...
@section('content')
    <div class="container px-6 pb-6 mx-auto ">
        <p class="text-2xl my-6 font-semibold text-gray-700">Produksi</p>
        {{-- <p>{{$data}}</p> --}}
        <div
            ...
            <div class="flex justify-start items-start md:items-center flex-col gap-4 w-full lg:flex-row ">
                ...
                <div class="flex justify-center items-center flex-col md:flex-row gap-4 w-full md:w-fit ">
                    <a href="{{ route('produksi.create') }}"
                        ...
                        <span class="font-semibold text-sky-600 text-sm">Tambah Data Produksi</span>
                    </a>
                </div>
            </div>
        </div>
                                    ...
                                    <td class="w-10 h-16  px-4 py-2  lg:whitespace-nowrap">
                                        <div class="flex justify-center items-center">
                                            <div class="w-6 h-6 cursor-pointer"
                                                ...
                                                <svg viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <g id="SVGRepo_iconCarrier">
                                                        <g id="Kebab-Menu" stroke="none" stroke-width="1"
                                                            fill="none" fill-rule="evenodd">
                                                            <rect id="Container" x="0" y="0" width="24"
                                                                height="24">
                                                            </rect>
                                                            <path
                                        ...
                                        <div id="dropdown{{ $loop->iteration }}"
                                            ...
                                            <ul class="text-sm text-gray-700 dark:text-gray-200 rounded-3xl"
                                                ...
                                                <li>
                                                    @if (auth()->check() && auth()->user()->hasRole('superadmin'))
                                                        <a href="{{ route('produksi.edit', $items->id) }}"
                                                ...
                                                <li>
                                                    @if (auth()->check() && auth()->user()->hasRole('superadmin'))
                                                        <form action="{{ route('produksi.destroy', $items->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
